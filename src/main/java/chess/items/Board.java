...
public class Board {
    ...
    public int NoKings = 2;
    public King white = new King(new Position(7, 3), ColorEnum.WHITE);
    public King black = new King(new Position(0, 3), ColorEnum.BLACK);
    ...
    private Board() {
        ...
        this.matrix[0][3] = this.black;
        this.matrix[7][3] = this.white;
    ...
    public boolean checkMate(){
        if((this.white.getLegalMoves().isEmpty() || this.black.getLegalMoves().isEmpty()) && (this.white.getPosition() != new Position(7, 3) && this.black.getPosition() != new Position(0, 3))){
            return true;
        }
        return false;
    }
